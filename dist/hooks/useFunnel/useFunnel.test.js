...
function TestComponent() {
  ...
  return (0, jsx_runtime_1.jsxs)(react_2.default.Fragment, {
    children: [
      (0, jsx_runtime_1.jsxs)(Funnel, {
        children: [
          (0, jsx_runtime_1.jsx)(Funnel.Step, {
            name: "step1",
            children: "Step 1 UI",
          }),
          (0, jsx_runtime_1.jsx)(Funnel.Step, {
...
describe("useFunnel hook", () => {
  ...
  it("should successfully render the first step in the funnel", () => {
    const { getByText, queryByText } = (0, react_1.render)(
      (0, jsx_runtime_1.jsx)(TestComponent, {})
    );
