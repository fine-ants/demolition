...
describe("getElapsedSince util function", () => {
  it('should return "방금" and "just now" for elapsed time less than a minute', () => {
    ...
    expect(getElapsedSince({ fromDate, language: "ko" })).toBe("방금");
    expect(getElapsedSince({ fromDate })).toBe("just now");
  });
  ...
  it('should return "1분 전" and "1minutes ago" for elapsed time 1 minutes', () => {
    ...
    expect(getElapsedSince({ fromDate, toDate, language: "ko" })).toBe(
      "1분 전"
    );
    expect(getElapsedSince({ fromDate, toDate })).toBe("1 minute ago");
  });
  ...
  it('should return "5분 전" and "5minutes ago" for elapsed time 5 minutes', () => {
    ...
    expect(getElapsedSince({ fromDate, toDate })).toBe("59 minutes ago");
  });
  ...
  it('should return "2시간 전" and "2hours ago" for elapsed time 2 hours', () => {
    ...
    expect(getElapsedSince({ fromDate, toDate })).toBe("2 hours ago");
  });
  ...
  it('should return "4일 전" and "4days ago" for elapsed time 4 days', () => {
    ...
    expect(getElapsedSince({ fromDate, toDate })).toBe("4 days ago");
  });
  ...
  it('should return "5일 전" and "5days ago" for elapsed time 4 days', () => {
    ...
    expect(getElapsedSince({ fromDate, toDate })).toBe("5 days ago");
  });
  ...
  it('should return "1달 전" and "1months ago" for elapsed time 1 months', () => {
    ...
    expect(getElapsedSince({ fromDate, toDate })).toBe("1 month ago");
  });
